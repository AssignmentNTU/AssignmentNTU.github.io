...
public class MovieDate implements Serializable,Comparable<MovieDate>{
	private String statusMovie="";
	private int year=0,month=0,day=0,hour=0,minute=0;
	private Cinema cinema; 
	
	//all constructor
	public MovieDate(Cinema cinema,String statusMovie , int year , int month , int day , int hour , int minute){
		this.cinema = cinema;
		this.year = year;
		this.month = month;
		this.day = day ;
	...
	public MovieDate(int year,int month,int day,int hour , int minute){
		this.year = year;
		this.month= month;
		this.day = day;
		this.hour = hour;
	...
	public MovieDate(String statusMovie,int year,int month,int day,int hour , int minute){
		this.statusMovie = statusMovie;
		this.year = year;
		this.month= month;
		this.day = day;
