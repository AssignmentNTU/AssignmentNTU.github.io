...
public class UserApplication implements Serializable{
	...
	private static ArrayList<MovieDate> movieScheduleList = new ArrayList<MovieDate>();
	...
	private static MovieDate choosenDate ;
	...
	private static void displayTicket(int timingChoice) throws Exception {
		...
		System.out.println("Showing cinema: " + movieChosen.getAvailableMovieDateList().get(choiceDate-1).getCinema().getCinemaName());
	...
	private static int requestInput(int userInterface){
		...
		switch(userInterface){
			...
			case SELECT_SEAT:
				Cinema showingCinema = movieChosen.getAvailableMovieDateList().get(choiceDate-1).getCinema();
